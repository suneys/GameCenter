    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="btn-group hidden-xs tooltip-demo" id="exampleTableEventsToolbar" role="group"
                ...
                <%--<button class="btn btn-default btn-outline" data-toggle="tooltip" data-placement="top" title="上传资源"--%>
                        <%--onclick="AddPro();">--%>
                    <%--<i class="glyphicon glyphicon-plus" aria-hidden="true"></i>--%>
                <%--</button>--%>
                <button class="btn btn-outline btn-default" data-intro=勾选资源后可点我快速发布
                        onclick="sendResource(1)" data-toggle="tooltip" data-placement="top" title="发布资源">
                ...
                <%--</button>--%>
                <button onclick="DelResource(0)" class="btn btn-outline btn-default" data-toggle="tooltip"
                        data-placement="top"
                        title="删除资源">
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" >
                            <div class="file-manager tooltip-demo">
                                <h5>文件夹</h5>
                                <ul id="treeDemo" class="ztree" style="font-size:18px;" data-intro=右击可以上传资源></ul>
                                <form id="form2" name="form2" method="post" action="#" enctype="multipart/form-data">

                                    <input type="file" name="s_file" id="s_file"
                                           accept=".JPG,.PNG,.GIF,.BMP,.JPEG,.MP4,.MP3"
                                ...
                                <div class="progress progress-striped active" style="display:none;" id="progress">
                                    <div style="width:0%;z-index:0;" aria-valuemax="100" aria-valuemin="0"
                                         aria-valuenow="75"
                                         role="progressbar" class="progress-bar progress-bar-warning"></div>
                                    <div id="progressfont"
                                         style="color:red;z-index:9999;position:absolute;width:85%; text-align:right;">
                                        0%
                                    </div>
                                </div>
                                <div id="Pagination" class="yellow1 ptb" style="padding-top:0px;"></div>
                                <ul class="folder-list" style="padding: 0;">
                                    <li style="margin-left:10%;"><span id="maxsize">Loding...</span>&nbsp;
                                        <%--<span--%>
                                                <%--class="glyphicon glyphicon-trash" style="cursor:pointer;"--%>
                                                <%--onclick="DelResource(0)"--%>
                                                <%--title="删除素材">--%>
                                        <%--</span>&nbsp;--%>
